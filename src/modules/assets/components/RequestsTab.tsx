...
import type { RequestStatus } from '../types/assets.types';
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-subtle">
                ...
                <th className="px-5 py-2.5 text-left text-xs font-medium text-fg-muted">Reason</th>
                    ...
                    <td className="px-5 py-3 text-right">
                      {isPending ? (
                        ...
                        <Button
                          variant="ghost"
                          size="sm"
                          onClick={() => toast.info(`Viewing request from ${r.requestedBy.name}`)}
                        >
                          View
                        </Button>
                      )}
