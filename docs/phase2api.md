...
```json
{
  ...
  "data": {
    ...
    "earnings": [
      { "code": "BASIC", "name": "Basic Salary", "amount": 50000.0, "taxable": true },
      { "code": "HRA", "name": "House Rent Allowance", "amount": 25000.0, "taxable": false },
      { "code": "LTA", "name": "Leave Travel Allowance", "amount": 5000.0, "taxable": false },
      { "code": "SPECIAL_ALLOW", "name": "Special Allowance", "amount": 20000.0, "taxable": true }
    ],
    "deductions": [
      { "code": "PF", "name": "Provident Fund", "amount": 6000.0 },
      { "code": "PROF_TAX", "name": "Professional Tax", "amount": 200.0 },
      { "code": "TDS", "name": "TDS (Income Tax)", "amount": 6600.0 }
    ],
    "oneTimeAdditions": [{ "description": "Performance Bonus Q1", "amount": 10000.0 }],
    "oneTimeDeductions": [],
    "grossEarnings": 100000.0,
    "totalDeductions": 12800.0,
    "netPay": 87200.0,
    ...
    "items": [
      {
        ...
        "status": "PAID",
        "employeeCount": 48,
        "totalGross": 4800000.0,
        "totalDeductions": 614400.0,
        "totalNet": 4185600.0,
        "currency": "INR",
...
```json
{
  ...
  "data": {
    ...
    "summary": {
      "byDepartment": [
        { "departmentName": "Engineering", "employeeCount": 12, "totalNet": 1245000.0 },
        { "departmentName": "HR", "employeeCount": 5, "totalNet": 390000.0 }
      ],
      "warnings": [
        {
          "employeeId": "emp_01JA",
...
{
  "oneTimeAdditions": [{ "description": "Performance Bonus Q1", "amount": 10000.0 }],
  "oneTimeDeductions": [{ "description": "Salary advance recovery", "amount": 5000.0 }],
